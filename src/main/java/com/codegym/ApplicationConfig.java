...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:8888/CaseStudy?useUnicode=yes&characterEncoding=UTF-8");
    ...
    @Bean
    public NoteSevice noteSevice(){
        return new NoteSeviceImpl();
    }
    @Bean
    public NoteTypeSevice noteTypeSevice(){
        return new NoteTypeSeviceImpl();
    }
    @Override
